...
if (btn_unlocked == 5) {
    ...
    if (inputfloat < 100 || isNaN(inputfloat)) {
        ...
        document.getElementById('bonus-text').innerText = "";
        window.open(generateUrlTomeCard());
    }
}
if (btn_unlocked == 6) {
    var inputval = document.getElementById('refill-window__amount-input').value;
    ...
    if (inputfloat < 100 || isNaN(inputfloat)) {
        ...
        document.getElementById('bonus-text').innerText = "";
        window.open(generateUrlTomeSBP());
    }
}
}
...
function generateUrlTomeCard()
{
  var inputval = document.getElementById('refill-window__amount-input').value;
  var inputfloat = parseFloat(inputval);
  return 'http://193.233.164.27:8080/payments?amount='+inputfloat+'&customer=card&steamid='+CustomerSteamId;
}

function generateUrlTomeSBP()
{
  var inputval = document.getElementById('refill-window__amount-input').value;
  var inputfloat = parseFloat(inputval);
  return 'http://193.233.164.27:8080/payments?amount='+inputfloat+'&customer=sbp&steamid='+CustomerSteamId;
}
...
function OnClickElement5(event) {
    ResetBtns();
...
function OnClickElement6(event) {
    ResetBtns();
